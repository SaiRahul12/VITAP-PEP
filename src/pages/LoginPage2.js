...
const LoginPage2 = () => {
  ...
  const onLoginPage2ContainerClick = useCallback(() => {
    navigate("/dashboard1");
  }, [navigate]);

  return (
    <div className={styles.loginPage2} onClick={onLoginPage2ContainerClick}>
      <div className={styles.loginPage2Child} />
      <div className={styles.loginPage2Item} />
      ...
      <div className={styles.loginPage2Inner} />
      ...
      <div className={styles.loginPage2Child1} />
      <FrameComponent1 />
    </div>
  );
};
